...
complete -c getty -s f -l issue-file -d 'Specifies a ":" delimited list of files and directories to be displayed inste…'
complete -c getty -l show-issue -d 'Display the current issue file (or other) on the current terminal and exit'
