...
complete -c e2image -s B -d 'Set the filesystem blocksize in bytes'
complete -c e2image -s c -d 'Compare each block to be copied from the source  device to the corresponding …'
complete -c e2image -s f -d 'Override the read-only requirement for the source filesystem when saving the …'
